    ...
    <section id="pricing" className="py-20 px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-indigo-600 font-semibold text-sm uppercase tracking-wide mb-3">PREVIEW</p>
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-4 text-sm font-medium text-gray-700">Q3 Marketing Strategy note</span>
              </div>
            ...
            <div className="grid lg:grid-cols-3 gap-0">
              ...
              <div className="lg:col-span-2 p-8 space-y-6">
                <div>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Q3 Marketing Strategy</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Our focus for Q3 will be on expanding our social media presence and{' '}
                    <span className="bg-red-100 text-red-900 px-1 rounded">launching the new content marketing campaign</span>
                ...
                <div>
                  <p className="text-gray-600 leading-relaxed mb-4">
                    ...
                    <span className="bg-yellow-100 text-yellow-900 px-1 rounded">leads</span>
                  ...
                  <ul className="space-y-2 ml-6">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-700">Launch influencer partnership program</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 mt-1">•</span>
                      <span className="text-gray-700">Redesign landing pages for better conversion</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600 mt-1">•</span>
                      <span className="text-gray-700">Implement email automation sequences</span>
                    </li>
                  </ul>
                </div>
